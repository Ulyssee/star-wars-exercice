    ...
    <div className="detail-view">
      ...
      {type === 'people' && (
        <div className="detail-card">
          ...
          <h3>Apparution dans ces films : </h3>
      ...
      {type === 'films' && (
        <div className="detail-card">
          <p className='name-detail-card'><strong>Titre :</strong> {item.title}</p>
          <div className='tab-detail-card'>
            <div>
          ...
          {(item.speciesObjects && item.speciesObjects.length > 0) ? (
            <div className="detail-card">
              ...
              <ul className="character-grid">
                {item.speciesObjects.map((sp, index) => (
                  <li key={index} className="character-item">{sp.name}</li>
                ))}
              </ul>
            </div>
          ) : (
            ...
            <div className="detail-card">
              ...
              <ul className="character-grid">
                {item.charactersObjects.map((char, index) => (
                  <li key={index} className="character-item">{char.name}</li>
                ))}
              </ul>
            </div>
          )}
          ...
          <h3>Texte d'ouverture du film</h3>
      ...
      {type === 'starships' && (
        <div className="detail-card">     
        <p className='name-detail-card'><strong>Nom du Vaisseau :</strong> {item.name}</p>
        <div className='tab-detail-card'>
          <div>
      ...
      {type === 'vehicles' && (
        <div className="detail-card">
          <p className='name-detail-card'><strong>Nom du véhicule :</strong> {item.name}</p>
          <div className='tab-detail-card'>
            <div>
              <p><strong>Modèle :</strong> {item.model}</p>
              <p><strong>Classe :</strong> {item.starship_class}</p>
      ...
      {type === 'species' && (
        <div className="detail-card">
          <p className='name-detail-card'><strong>Nom de l'espèce :</strong> {item.name}</p>
          <div className='tab-detail-card'>
            <div>
